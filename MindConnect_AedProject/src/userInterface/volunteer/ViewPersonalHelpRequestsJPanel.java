...
public class ViewPersonalHelpRequestsJPanel extends javax.swing.JPanel {
   ...
   private UserAccount userAccount;  
    ...
    new String [] {
        "Request Type", "Patient", "Requested Date", "Status"
    }
) {
...
//    }
    ...
    for (WorkRequest workRequest : userAccount.getWorkQueue().getWorkRequestList()) {
        if (workRequest instanceof NeedHelpWorkRequest) {
            NeedHelpWorkRequest helpRequest = (NeedHelpWorkRequest) workRequest;
            Object[] rowData = new Object[4];
            rowData[0] = helpRequest.getRequestType(); // Add this field to NeedHelpWorkRequest
            rowData[1] = helpRequest.getPatientName(); // Add this field to NeedHelpWorkRequest
            rowData[2] = dateFormat.format(helpRequest.getRequestDate());
            rowData[3] = helpRequest.getStatus();
            dtm.addRow(rowData);
        }
    }
}
